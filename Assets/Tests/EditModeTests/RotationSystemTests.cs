...
public class RotationSystemTests
{
    ...
    {
        var modelMock = new Mock<IContextEntityStrategy<IRotatable, IInputProvider>>();
        modelMock.Setup(m 
    ...
    {
        var rotationSystem = new RotationSystem(Mock.Of<IContextEntityStrategy<IRotatable, IInputProvider>>());
